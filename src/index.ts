...
import './global.scss';
import pageResourceType from './workspace/PageResourceType';
import { viewSwitcher } from './workspace/sample-plugins/scenario-switcher';

export async function registerPlugins(ctx: any, type: string = 'A') {
...
(async function main() {
  ...
  workspace.registerResourceType(pageResourceType as any);
  await workspace.plugins.register(viewSwitcher as any);
